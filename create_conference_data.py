...
def create_sample_data():
    ...
    page, created = ConferencePage.objects.get_or_create(
        defaults={
            ...
            'meta_keywords': 'conference rooms, meeting facilities, board rooms, training rooms, nairobi',
            'is_active': True,
        }
    )
    ...
    categories_data = [
        ...
        },
        {
            ...
            'description': 'Interactive spaces designed for effective training and workshop sessions',
    ...
    conference_hall, created = ConferenceRoom.objects.get_or_create(
        ...
        defaults={
            'category': categories['meeting-hall'],
    ...
    meeting_rooms_standard = [
        {
            ...
            'name': 'Bamboo Meeting Room',
            'room_type': 'standard',
            'description': 'Spacious meeting room with natural lighting and comfortable seating. Ideal for team meetings and client presentations.',
            'capacity_classroom': 70,
            'capacity_theatre': 100,
            'capacity_banquet': 70,
            'capacity_u_shape': 0,
        ...
        },
        {
            ...
            'category': categories['meeting-rooms'],
            'name': 'Cactus Meeting Room',
            'room_type': 'standard',
            'description': 'Versatile meeting space with modern amenities and flexible layout options.',
            'capacity_classroom': 70,
            'capacity_theatre': 100,
            'capacity_banquet': 70,
            'capacity_u_shape': 0,
    ...
    meeting_rooms_executive = [
        {
            'slug': 'japonica-executive-room',
            'category': categories['meeting-rooms'],
            'name': 'Japonica Executive Room',
            'room_type': 'executive',
            'description': 'Premium executive meeting room with leather seating and advanced technology.',
        ...
        {
            'slug': 'melia-executive-room',
            'category': categories['meeting-rooms'],
            'name': 'Melia Executive Room',
            'room_type': 'executive',
            'description': 'Executive meeting space with panoramic garden views and premium amenities.',
            'capacity_classroom': 50,
            'capacity_theatre': 70,
            'capacity_banquet': 50,
            'capacity_u_shape': 20,
        ...
        room, created = ConferenceRoom.objects.get_or_create(
            ...
            defaults={
                **room_data,
                ...
                'full_day_rate': 4500.00,
                'hourly_rate': 1000.00,
                'meta_title': f"{room_data['name']} - Executive Meeting Room",
                'meta_description': f"Executive meeting room for up to {room_data['capacity_theatre']} people",
                'is_featured': True,
            }
        )
